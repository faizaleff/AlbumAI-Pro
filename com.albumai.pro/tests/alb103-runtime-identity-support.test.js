...
try {
    ...
    check(webpackSource.includes("maxAssetSize: 732 * 1024"), "production bundle budget is not explicit");
    check(webpackSource.includes("maxEntrypointSize: 732 * 1024"), "production entrypoint budget is not explicit");
