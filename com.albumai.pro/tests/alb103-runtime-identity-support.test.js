...
try {
    ...
    check(webpackSource.includes("maxAssetSize: 705 * 1024"), "production bundle budget is not explicit");
    check(webpackSource.includes("maxEntrypointSize: 705 * 1024"), "production entrypoint budget is not explicit");
