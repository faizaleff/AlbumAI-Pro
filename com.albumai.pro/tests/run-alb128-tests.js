...
const outputPath = fs.mkdtempSync(path.join(os.tmpdir(), "albumai-alb128-"));

webpack({
    mode: "development",
    target: "node",
    entry: path.join(__dirname, "alb128-typography-multisheet-stabilization.test.js"),
    ...
    module: { rules: [{
        ...
        loader: "babel-loader",
        options: { plugins: ["@babel/plugin-transform-object-rest-spread", "@babel/plugin-transform-react-jsx"] }
    }] }
}, (error, stats) => {
