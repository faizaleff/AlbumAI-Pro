...
try {
    ...
    check(photoBrowser.includes("Sequence incomplete"), "incomplete Sequence warning is missing");
    check(photoBrowser.includes("Save as Album Selects →"), "Sequence-to-Album-Selects handoff is missing");
    check(photoBrowser.includes("No Album Selects"), "empty Album Selects warning is missing");
    check(photoBrowser.includes("To review ·"), "unrated-photo review filter is missing");
    ...
    check(photoBrowser.includes('"Review the Library"'), "Library screen title is missing");
    check(photoBrowser.includes('"Build the album sequence"'), "Sequence screen title is missing");
    check(photoBrowser.includes("Continue to Sequence ·"), "Library-to-Sequence primary handoff is missing");
    check(photoBrowser.includes("AI-assisted sequence <em>Future</em>"), "future AI story provision is not visibly bounded");
    check(photoBrowser.includes("photos.length > 0 && workflowStep === 1"), "review controls are not isolated to the Library step");
    ...
    check(photoBrowser.includes('"Review the final album selects"'), "Album Selects title is missing");
    check(photoBrowser.includes('id="photo-cull-status"'), "Cull status controls are not consolidated");
    check(photoBrowser.includes("workflowStep === 1 && secondaryFiltersOpen"), "advanced Library controls leak into other steps");
    ...
    check(photoBrowser.includes("decisionControlsVisible={workflowStep === 1 || (workflowStep === 3 && !albumSelectsLocked)}"), "photo decision controls do not respect Library/Album Selects review state");
