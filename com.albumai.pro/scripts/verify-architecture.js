...
function main() {
    ...
    check(policy.activeFiles.length === 118, "Architecture policy must list all 118 active files.");
    ...
    check(sameFiles(reachable, policy.activeFiles),
        "The canonical entry graph no longer reaches exactly the 118 active files.");
