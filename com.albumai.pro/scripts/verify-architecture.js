...
function main() {
    ...
    check(policy.activeFiles.length === 97, "Architecture policy must list all 97 active files.");
    ...
    check(sameFiles(reachable, policy.activeFiles),
        "The canonical entry graph no longer reaches exactly the 97 active files.");
