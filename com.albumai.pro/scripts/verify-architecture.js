...
function main() {
    ...
    check(policy.activeFiles.length === 100, "Architecture policy must list all 100 active files.");
    ...
    check(sameFiles(reachable, policy.activeFiles),
        "The canonical entry graph no longer reaches exactly the 100 active files.");
