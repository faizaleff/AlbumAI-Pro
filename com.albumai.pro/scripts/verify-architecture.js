...
function main() {
    ...
    check(policy.activeFiles.length === 101, "Architecture policy must list all 101 active files.");
    ...
    check(sameFiles(reachable, policy.activeFiles),
        "The canonical entry graph no longer reaches exactly the 101 active files.");
