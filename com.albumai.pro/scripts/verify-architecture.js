...
function main() {
    ...
    check(policy.activeFiles.length === 114, "Architecture policy must list all 114 active files.");
    ...
    check(sameFiles(reachable, policy.activeFiles),
        "The canonical entry graph no longer reaches exactly the 114 active files.");
