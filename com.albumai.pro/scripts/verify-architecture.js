...
function main() {
    ...
    check(policy.activeFiles.length === 123, "Architecture policy must list all 123 active files.");
    ...
    check(sameFiles(reachable, policy.activeFiles),
        "The canonical entry graph no longer reaches exactly the 123 active files.");
