...
function main() {
    ...
    check(policy.activeFiles.length === 117, "Architecture policy must list all 117 active files.");
    ...
    check(sameFiles(reachable, policy.activeFiles),
        "The canonical entry graph no longer reaches exactly the 117 active files.");
