...
function main() {
    ...
    check(policy.activeFiles.length === 122, "Architecture policy must list all 122 active files.");
    ...
    check(sameFiles(reachable, policy.activeFiles),
        "The canonical entry graph no longer reaches exactly the 122 active files.");
