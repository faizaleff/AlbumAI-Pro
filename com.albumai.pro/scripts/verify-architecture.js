...
function main() {
    ...
    check(policy.activeFiles.length === 113, "Architecture policy must list all 113 active files.");
    ...
    check(sameFiles(reachable, policy.activeFiles),
        "The canonical entry graph no longer reaches exactly the 113 active files.");
