...
function main() {
    ...
    check(policy.activeFiles.length === 109, "Architecture policy must list all 109 active files.");
    ...
    check(sameFiles(reachable, policy.activeFiles),
        "The canonical entry graph no longer reaches exactly the 109 active files.");
