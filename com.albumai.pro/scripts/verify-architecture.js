...
function main() {
    ...
    check(policy.activeFiles.length === 116, "Architecture policy must list all 116 active files.");
    ...
    check(sameFiles(reachable, policy.activeFiles),
        "The canonical entry graph no longer reaches exactly the 116 active files.");
