...
function main() {
    ...
    check(policy.activeFiles.length === 111, "Architecture policy must list all 111 active files.");
    ...
    check(sameFiles(reachable, policy.activeFiles),
        "The canonical entry graph no longer reaches exactly the 111 active files.");
