...
function main() {
    ...
    check(policy.activeFiles.length === 95, "Architecture policy must list all 95 active files.");
    ...
    check(sameFiles(reachable, policy.activeFiles),
        "The canonical entry graph no longer reaches exactly the 95 active files.");
