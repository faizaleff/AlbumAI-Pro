...
function main() {
    ...
    check(policy.activeFiles.length === 115, "Architecture policy must list all 115 active files.");
    ...
    check(sameFiles(reachable, policy.activeFiles),
        "The canonical entry graph no longer reaches exactly the 115 active files.");
