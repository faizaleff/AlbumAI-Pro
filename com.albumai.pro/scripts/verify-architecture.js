...
function main() {
    ...
    check(policy.activeFiles.length === 107, "Architecture policy must list all 107 active files.");
    ...
    check(sameFiles(reachable, policy.activeFiles),
        "The canonical entry graph no longer reaches exactly the 107 active files.");
